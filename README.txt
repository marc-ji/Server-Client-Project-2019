...
a4Server2.c - runs a server that only terminates connection upon reception of end command, terminates itself with alarm, handles more than one client via forking
